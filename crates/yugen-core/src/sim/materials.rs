//! The materials facade — the one place `yugen-data`'s block tables are named
//! the way the engine speaks about them.
//!
//! Hand-written code never imports `yugen_data::blocks` directly; it comes
...
pub use yugen_data::blocks::{
    ...
    MAT_STATE, MAT_TAGS, MAT_TEXTURE, MAT_VISCOSITY, NEVER, Tag, Tex, block, grow_onto,
};
