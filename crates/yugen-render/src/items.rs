...
//!
//! `yugen-core`'s [`items`](yugen_core::items) layer is five modules that
//! know nothing about Bevy and nothing about each other beyond one arrow. This
//! module is the host that makes them a game loop:
//!
//! | Wire | From | To |
//! |---|---|---|
//! | mined cells | [`BuildTool`](yugen_core::interact::BuildTool)'s bag | [`GroundItems`] |
//! | killed creatures | [`MobSystem::loot`](yugen_core::entities::mobs::MobSystem::loot) | [`GroundItems`] |
...
//! [`AmmoSource`](yugen_core::entities::AmmoSource) is a
...
/// this resource. [`AmmoSource`](yugen_core::entities::AmmoSource) is a trait
...
mod tests {
    use super::*;
    use yugen_core::entities::AmmoSource;
    use yugen_core::items::{item_code_of, registry::ITEM_DEFS};
