//! Template structures — the facade over `godgame-data`'s compiled struct
...
// through `godgame_data::structs` directly, exactly as `sim::materials` is the
