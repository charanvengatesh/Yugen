...
use yugen_core::items::inventory::{HOTBAR, SLOT_COUNT};
use yugen_core::json::Json;
...
fn item_id(code: yugen_core::items::registry::ItemCode) -> &'static str {
    yugen_data::items::ITEMS
        .get(code as usize)
        .map_or("?", |d| d.id)
}
