...
//! of the same boundary the rest of the crate is: `yugen-core` may not know
...
//!
//! [`YugenRenderPlugin`] is all of them, which is what the binary wants.
//!
...
pub struct YugenRenderPlugin;

impl PluginGroup for YugenRenderPlugin {
