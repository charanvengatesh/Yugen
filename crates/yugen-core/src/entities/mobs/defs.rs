//! The bestiary — a facade over `yugen_data::mobs`.
//!
...
//! hand-written code never imports `yugen_data::mobs` directly, it comes
//! through here.
//!
...
pub use yugen_data::mobs::MobSpecBands as MobBand;

/// A creature's ranged attack. Every field is a duration, a radius or damage —
/// none are body-scaled.
pub use yugen_data::mobs::MobSpecRanged as MobRanged;

use yugen_data::mobs::{MOBS, MobSpec};
