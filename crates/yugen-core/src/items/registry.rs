//! The item registry — a facade over `yugen_data::items`, exactly as
//! [`crate::sim::materials`] is one over `yugen_data::blocks`.
//!
...
//! module.
//!
//! Hand-written code imports from HERE and never from `yugen_data` directly,
