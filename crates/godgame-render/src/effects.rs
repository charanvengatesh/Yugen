...
use godgame_core::entities::mobs::MobEventKind;
...
/// [`MobEvent`](godgame_core::entities::mobs::MobEvent)s take ONE parameter and
/// make ONE call.
///
...
///
/// Not in [`GodGameRenderPlugin`](crate::GodGameRenderPlugin) yet: nothing calls
