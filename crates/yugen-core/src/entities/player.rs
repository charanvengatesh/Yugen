...
//! never said. That is the same standard `yugen_render::particles` holds
...
impl Player {
    ...
    // rebuilt in `yugen-render` without this crate growing a pixel of
    ...
    pub fn reset(&mut self) {
        ...
        // line as this reset. `yugen_render::glue::start_a_run` is the one
