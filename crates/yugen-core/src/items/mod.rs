...
//! | Module | Owns |
//! |---|---|
//! | [`registry`] | the facade over `yugen_data::items`, plus the three indexes the compiler cannot emit |
...
//! exactly as it did, and `yugen-render` does the baking. The dedup-by-id map
