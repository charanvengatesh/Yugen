...
use yugen_core::sim::worldgen::{ChunkGen, SPAWN_COL, material_at, spawn_point, world_noise};

/// Whether this run should rewrite the baseline instead of comparing.
///
/// `YUGEN_BLESS=1`, the same switch `registry_golden.rs` uses. The comparisons
